...
public class Board {
    ...
    public static final int[][] DELTAS = {{1, 0}, {0, 1}, {-1, 1}, {1, 1}}; 
    ...
    public void makeMove(Move move) {
        ...
        int free = getFree(col);
        if(free == -1) throw new IllegalArgumentException("Column is full.");
        board[free][col] = move.getPlayer();
        lastMove = move;
    }
    ...
    /**
     * Gets the bottom most free row in a given column.
     * If the column is full, returns -1.
     * 
     * @param col
     * @return
     */
    private int getFree(int col) {
    	int free = NUM_ROWS - 1;
    ...
    public Move[] getPossibleMoves(Player p) {
        ...
        List<Move> rt = new ArrayList<Move>();
